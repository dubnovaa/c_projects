...
START_TEST(incorrect_matrix_1) {
  ...
  ck_assert_int_eq(mul_code, CALC);
...
START_TEST(sub_test_incorrect_matrix2) {
  matrix_t A, B, R;
  s21_create_matrix(2, 1, &A);
  s21_create_matrix(2, 1, &B);
...
START_TEST(sum_test_incorrect_matrix2) {
  matrix_t A, B, R;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
...
Suite *s21_matrix_suite(void) {
  ...
  tcase_add_test(tc_core, compliment_test_1);
  tcase_add_test(tc_core, compliment_test_2);
  tcase_add_test(tc_core, compliment_test_not_square);
  tcase_add_test(tc_core, compliment_test_1x1);
  tcase_add_test(tc_core, null_compliments);
  tcase_add_test(tc_core, create_test);
  tcase_add_test(tc_core, create_test_incorrect);
  tcase_add_test(tc_core, determinant_test_1);
  tcase_add_test(tc_core, determinant_test_2);
  tcase_add_test(tc_core, determinant_test_3x3_1);
  tcase_add_test(tc_core, determinant_test_3x3_2);
  tcase_add_test(tc_core, determinant_test_3x3_3);
  tcase_add_test(tc_core, determinant_test_3x3_4);
  tcase_add_test(tc_core, determinant_test_4x4);
  tcase_add_test(tc_core, determinant_test_4x4_2);
  tcase_add_test(tc_core, determinant_test_5x5);
  tcase_add_test(tc_core, determinant_not_square);
  tcase_add_test(tc_core, null_determinate);
  tcase_add_test(tc_core, eq_test_1);
  tcase_add_test(tc_core, eq_test_2);
  tcase_add_test(tc_core, eq_test_3);
  tcase_add_test(tc_core, eq_test_diff_size);
  tcase_add_test(tc_core, test_normal);
  tcase_add_test(tc_core, test_not_sqare);
  tcase_add_test(tc_core, null_inverse);
  tcase_add_test(tc_core, zero_det);
  tcase_add_test(tc_core, incorrect_matrix_1);
  tcase_add_test(tc_core, incorrect_matrix_2);
  ...
  tcase_add_test(tc_core, null_mult_mat);
  ...
  tcase_add_test(tc_core, null_mult_num);
  tcase_add_test(tc_core, remove_test);
  tcase_add_test(tc_core, sub_test_1);
  tcase_add_test(tc_core, sub_test_2);
  tcase_add_test(tc_core, sub_test_incorrect_matrix);
  tcase_add_test(tc_core, sub_test_incorrect_matrix2);
  tcase_add_test(tc_core, null_sub);
  tcase_add_test(tc_core, sum_test_1);
  tcase_add_test(tc_core, sum_test_2);
  tcase_add_test(tc_core, sum_test_incorrect_matrix);
  tcase_add_test(tc_core, sum_test_incorrect_matrix2);
  tcase_add_test(tc_core, null_sum);
  tcase_add_test(tc_core, transpose_test_1);
  tcase_add_test(tc_core, transpose_test_2);
  tcase_add_test(tc_core, transpose_incorrect);
  tcase_add_test(tc_core, null_transpose);
  return s;
}
